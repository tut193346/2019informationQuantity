...
public class TestCase {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("checking s4.B193346.Frequencer");
        ...
        try {
            ...
            freq2 = myObject.frequency();
            System.out.print("\"Hi_\" in \"Hi Ho Hi Ho\" appears "+freq2+" times. ");
        ...
        try {
            ...
            System.out.println("checking s4.B193346.Frequencer");
            myObject = new s4.B193346.Frequencer();
            //test the method"subByteFrequency"
            int sbfreq;
            myObject.setTarget("Hi Ho".getBytes());
            sbfreq = myObject.frequency(0,1);
            System.out.print("\"Hi\" in \"Hi Ho Hi Ho\" appears "+sbfreq+" times. ");
            if(2 == sbfreq) { System.out.println("OK"); } else {System.out.println("WRONG"); }
        }
        catch(Exception e) {
            System.out.println("Exception occurred: STOP");
        }
